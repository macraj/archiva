...
class MailAccount(Base):
    ...
    # NOWE POLA do śledzenia archiwizacji
    ...
    archived_emails: Mapped[List["ArchivedEmail"]] = relationship(back_populates="account")
...
class ArchivedEmail(Base):
    ...
    # Relacje
    account: Mapped["MailAccount"] = relationship(back_populates="archived_emails")